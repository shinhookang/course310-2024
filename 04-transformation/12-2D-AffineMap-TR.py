...
vec3 dvec = vec3(1./2., 1./4., 0.);  
mat3 Tmat = mat3(1., 0., 0.,   0., 1., 0.,   dvec.x, dvec.y, 1.0);  
float deg = 10;
float rad = radians(deg);
mat3 Rmat = mat3(cos(rad), sin(rad), 0.,   -sin(rad), cos(rad), 0.,   0., 0., 1.0);  
void main()
{
    gl_Position = vec4(vertexPosition, 1.0); // w
    gl_Position.xyw = Tmat * Rmat * gl_Position.xyw; 
