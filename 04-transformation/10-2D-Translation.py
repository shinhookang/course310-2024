...
mat2 Amat = mat2(1., 0., 0., 1.);  
vec2 dvec = vec2(1./2., 1./4.);  
void main()
{
    gl_Position = vec4(vertexPosition, 1.0); // w
    gl_Position.xy = Amat * vertexPosition.xy + dvec; 
    // gl_Position.x = vertexPosition.x + dvec.x;  
    // gl_Position.y = vertexPosition.y + dvec.y;  
